...
public class ReactionRecord {
    ...
    public List<Reaction> getAvailableReactionsList() {
        Set<String> availableReactions = getAvailableReactions();
        return availableReactions.stream()
            .map(ReactionFactory::create)
            .toList();
    }
    ...
    public final void unlockBattle(int battleNumber) {
        flagManager.addFlag("BATTLE_" + String.valueOf(battleNumber));
    }

    public final void lockBattle(int battleNumber) {
