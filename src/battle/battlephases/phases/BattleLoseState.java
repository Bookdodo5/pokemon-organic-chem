...
public class BattleLoseState extends BattlePhase {
    ...
    public BattleLoseState(PhaseManager phaseManager, KeyBindingHandler keyHandler, StateManager stateManager, FlagManager flagManager) {
    ...
    public void update() {
        ...
        if(animationTimer < totalDuration / 3) {
            ...
            battleRenderer.setPlayerMoleculeOffsetY(moleculeOffsetY);
        }
    ...
    @Override
    public void onEnter() {
        flagManager.addFlag("BATTLE_LOSE");
        animationTimer = 0;
